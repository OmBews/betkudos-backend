...
return [
    ...
    */
    ...
    'options' => [
        'application' => env('APP_NAME', 'Betkudos'),
        'repository' => 'git@gitlab.com:sportbook-crypto-platform/crypto-sportsbook.git',
        'shared_files' => [
            '.env'
        ],
    ],
    ...
    */
    ...
    'hosts' => [
        'stg-api.betkudos.com' => [
            'deploy_path' => '/var/www/crypto-sportsbook',
            'user' => 'root',
        ],
    ],
